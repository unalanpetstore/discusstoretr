...
export default function Home() {
  ...
  return (
    <div>
      <header style={{background:'#062b33', color:'white', padding:'80px 20px', textAlign:'left'}}>
        <div style={{maxWidth:1100, margin:'0 auto'}}>
          <h1 style={{fontSize:48, margin:0}}>DiscusStore.com.tr<sup style={{fontSize:18}}>®</sup></h1>
            ...
            <div key={p.id} style={{border:'1px solid #eee', borderRadius:8, overflow:'hidden'}}>
              ...
              <div style={{padding:12}}>
                ...
                <div style={{marginTop:10, display:'flex', justifyContent:'space-between', alignItems:'center'}}>
                  ...
                  <Link href={`/products/${p.slug}`}><a style={{color:'#0b76c9'}}>Detay</a></Link>
                </div>
              </div>
            </div>
          ))}
      ...
      <footer style={{background:'#111', color:'#ddd', padding:20, marginTop:40}}>
        <div style={{maxWidth:1100, margin:'0 auto', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          <div>© 2025 DiscusStore.com.tr® — Ünalan Pet Store® kuruluşudur.</div>
